...
class connectServer:  #ORIG_NETWORKING
    ...
    def checkin(self, vehicle_id, x, y, z, roll, pitch, yaw, steeringAcceleration, motorAcceleration, targetIndexX, targetIndexY, detections): #ORIG_NETWORKING
    ...
    def getSimPositions(self, vehicle_id): #ORIG_NETWORKING
        ...
        # data to be sent to api 
        packet = {'key':self.key,  #ORIG_NETWORKING
                'id':vehicle_id,  #ORIG_NETWORKING
                'type':0} #ORIG_NETWORKING
